...
(function($) {
    ...
    (function() {
        ...
        Tags.Templates["2"].tag = function(options) {
            ...
            if(options.isReadOnly){
            	return "<a class='tag label " + options.tagClass + " " + options.tagSize + "' " + (options.isPopover ? "rel='popover'" : "") + ">    <span>" + Tags.Helpers.addPadding(options.tag, 2, options.isReadOnly) + "</span>    " + (options.isReadOnly ? "" : "<a><i class='remove icon-remove-sign icon-white' /></a>") + "  </a>";
            }else{
    ...
    (function() {
        ...
        Tags.Templates["3"].tag = function(options) {
            ...
            if(options.isReadOnly){
                return "<a href='/entries/tag?id="+options.tag+"' class='tag label " + options.tagClass + " " + options.tagSize + "' " + (options.isPopover ? "rel='popover'" : "") + ">    <span>" + Tags.Helpers.addPadding(options.tag, 2, options.isReadOnly) + "</span>    " + (options.isReadOnly ? "" : "<a><i class='remove glyphicon glyphicon-remove-sign glyphicon-white' /></a>") + "  </a>";
            }else{
